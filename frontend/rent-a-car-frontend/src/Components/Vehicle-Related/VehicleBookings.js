...
class VehicleBooking extends React.Component {
  ...
  handleClose(e){
    ...
    this.props.returnCar(reservation._id, {comment, rating, condition}, (err, response) => {
  ...
  handleReturnClick(e) {
    this.setState((prevState) => {
      return ({
        showModal : !prevState.showModal, reservation : e
      })
    })
  }
  ...
  render() {
    ...
    const commentModal = (
        <CommentModal show={true} title = "Give some feedback ?" onClose = {this.handleShowModal} onSubmit = {this.handleClose}>
          <div class="form-group">
            <label for="comments-area">Comments(optional)</label>
            <textarea name = 'comment' class="form-control" id="comments-area" rows="3" onChange = {this.onChangeHandler}></textarea>
          </div>
          <div class="form-group">
            <label for="rate-experience">Rating(optional)</label>
            <select name = 'rating' class="form-control" id="rate-experience" onChange = {this.onChangeHandler}>
              <option>1</option>
              <option>2</option>
              <option>3</option>
              <option>4</option>
          ...
          <div class="form-group">
            ...
            <select name = 'condition' class="form-control" id="rate-condition" onChange = {this.onChangeHandler} >
              <option>Good</option>
    ...
    return (
      ...
      {this.state.redirectVar}
        ...
        <div className="list-container">
          ...
          {this.props.reservation !== undefined && this.props.reservation.returned !== undefined && (
            <BookingCell
...
export default connect(matchStateToProps, { fetchMyBookings, returnCar, cancelBooking })(VehicleBooking);
